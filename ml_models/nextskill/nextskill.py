...
if __name__ == "__main__":
    ...
    # Example usage
    user_skill_percentages = {"Flutter ": 90, "Dart ": 80, "React Native ": 80, "Swift (iOS) ": 80, "Kotlin (Android) ": 70, "Firebase ": 70, "UI Design Principles ": 80, "API Integration ": 80}
    user_skill_percentages = {k.strip(): v for k, v in user_skill_percentages.items()}
